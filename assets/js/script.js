...
function setSlider() {
    ...
    if (active === 0) {
        container.style.backgroundImage = 'radial-gradient(circle, #000000, #8B0000)';
        activeDescription.style.color = cor1;
        activeCarInfo.style.color = cor1;
        activeH2.style.color = cor1;
        activeLi.style.backgroundColor = cor1; 
    } 
     else if (active === 1) {
         container.style.backgroundImage = 'radial-gradient(circle, #C0C0C0, #B0C4DE)';
         ...
         container.style.backgroundImage = 'radial-gradient(circle, #00008B, #363636)';
